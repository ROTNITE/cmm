...
original_query
-> query_intake
-> expert role selection + expert panel round 1
-> balance analysis round 1
-> deliberation brief round 1
-> semantic conflict / consensus analysis round 1
-> meta moderation
-> if conflict/meta state requires deliberation:
     -> structured deliberation round over selected base roles
     -> merge deliberation revisions into expert bundle
     -> balance analysis after deliberation
     -> rebuild deliberation brief
     -> semantic conflict / consensus analysis after deliberation
-> if DEEPEN/ADD_EXPERT:
     -> select targeted follow-up roles
     -> expert panel round 2
     -> merge expert bundles
     -> balance analysis round 2
     -> rebuild deliberation brief
     -> semantic conflict / consensus analysis round 2
-> plan generation
-> plan critique
-> answer generation
-> answer moderation + revision loop
...
- `Lib/orchestrator.py` owns the ordered pipeline and trace assembly.
